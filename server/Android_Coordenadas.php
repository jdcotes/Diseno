...
$consulta=mysql_query("INSERT INTO $_POST[coordenadas] (Fecha,Hora,Latitud,Longitud) VALUES($_POST[Fecha_Hora_gps]','$fecha_servidor','$_POST[Latitud_gps]','$_POST[Longitud_gps]')");
